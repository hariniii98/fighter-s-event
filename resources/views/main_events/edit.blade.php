 ...
 <!-- Main Content -->
      ...
      <div class="section-body">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <form id="setting-form" method="POST" action="{{route('main_events.update',$main_event->id)}}" enctype="multipart/form-data">
                    @csrf
                        <div class="card" id="settings-card">
                        <div class="card-header">
                        <h4>Edit Main Event</h4>
                        </div>
                        <div class="card-body">
                            <div class="form-group row align-items-center">
                                <label for="name" class="form-control-label col-sm-3 text-md-right">Name<span class="text-danger"> *</span></label>
                                <div class="col-sm-6 col-md-9">
                                <input type="text" name="name" class="form-control" id="name" value="{{$main_event->name}}" autocomplete="off" required>
                                </div>
                            </div>
                            <div class="form-group row align-items-center">
                                ...
                                @if(in_array($event->id,$sub_ev_ids))
                                <input type="checkbox" name="event_id[]" id="{{$event->name}}" value="{{$event->id}}" checked>
