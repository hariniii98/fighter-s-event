...
@include('elements.settings_section')
 ...
 <!-- Main Content -->
      ...
      <div class="section-body">
        <h2 class="section-title">Extra Ranking Points</h2>
        ...
        <div class="row">
            ...
            <div class="card">
                ...
                <div class="table-responsive">
                    ...
                    @php $s_no=1; @endphp
                    @foreach($extra_ranking_points as $row)
                    <tr>
                        ...
                        <td>{{$s_no++}}</td>
                        <td>{{$row->name}}</td>
                        <td>{{$row->additional_points}}</td>
                        <td><a href="{{route('extra_ranking_point.delete',$row->id)}}" class="btn btn-secondary" onclick="return confirm('Are you sure,you want to delete?')"><i class="fa fa-trash btn-danger"></i></a></td>
                    </tr>
                    @endforeach
                    </table>
                </div>
