 ...
 <!-- Main Content -->
      ...
      <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
          ...
          <div class="breadcrumb-item">Referees</div>
        </div>
      </div>
      ...
      <div class="section-body">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <form id="setting-form" method="POST" action="{{route('referee_event_ring.store',$judge_id)}}" enctype="multipart/form-data">
                    @csrf
                        <div class="card" id="settings-card">
                        <div class="card-header">
                        <h4>Edit Super Referee {{$judge->first_name}}&nbsp;{{$judge->last_name}}</h4>
                        </div>
                        <div class="card-body">
